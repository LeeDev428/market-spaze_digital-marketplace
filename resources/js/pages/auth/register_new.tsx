                ...
                <div className="flex bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full h-[600px]">
                    ...
                    <div className="w-full md:w-3/5 p-6 flex flex-col">
                        <div className="text-center mb-4">
                            ...
                            <p className="text-gray-600 text-sm">Use your email to register</p>
                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full border border-gray-300 rounded-md px-2 py-1.5 text-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none"
                                                >
                                    ...
                                    <div className="mt-2">
                                        <div className="flex space-x-2 text-xs">
                                            {passwordChecks.map((check, index) => (
                                                <div key={index} className={`flex items-center space-x-1 ${check.valid ? 'text-green-600' : 'text-gray-400'}`}>
                                                    <Check size={10} className={check.valid ? 'text-green-600' : 'text-gray-300'} />
